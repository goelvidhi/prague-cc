...
\newcommand*{\metaversion}{0C}
\newcommand*{\metadate}{02 Dec 2020}
...
\metaversion &\metadate  &Bob Briscoe &Altered algorithms from hand-crafted repetitive\_div() to div() in stdlib\\\hline%
\hline%
\end{tabular}
